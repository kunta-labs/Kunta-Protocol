...
var root = "/Users/jovonnipharr/Documents/projects/kunta_wasm"
var wasm_loc = root+'/rs/VirtualMachine/target/wasm32-unknown-unknown/release/virtual_machine.wasm';
const buf = fs.readFileSync(wasm_loc);
...
function RUN_WASM(SCRIPT, callback){
  ...
  .then((instance) => {
    console.log('[Finished compiling WASM VM]');
